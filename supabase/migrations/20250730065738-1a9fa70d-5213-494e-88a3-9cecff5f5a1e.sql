...
CREATE INDEX boards_board_id_idx ON public.boards(board_id);
CREATE INDEX cards_board_id_idx ON public.cards(board_id);
CREATE INDEX cards_column_id_idx ON public.cards(column_id);
CREATE INDEX votes_card_id_idx ON public.votes(card_id);
CREATE INDEX action_items_board_id_idx ON public.action_items(board_id);
CREATE INDEX board_participants_board_id_idx ON public.board_participants(board_id);
